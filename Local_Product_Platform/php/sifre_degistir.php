...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['current_password'], $_POST['new_password'], $_POST['email'])) {
        $current_password = $_POST['current_password'];
        $new_password = $_POST['new_password'];
        $email = $_POST['email'];

        // Mevcut şifre ve e-posta doğrulaması
        ...
        if ($result->num_rows > 0) {
            ...
            $error_message = "Mevcut şifre veya e-posta adresi yanlış!";
        }
    }
}
?>
